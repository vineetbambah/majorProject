"""Large ANN model module for distributed training benchmarks."""
import torch
...
class SimpleANN(nn.Module):
    """Large fully connected network for Fashion-MNIST benchmark runs."""

    def __init__(self, input_dim: int = 28 * 28, hidden_dim: int = 256, output_dim: int = 10):
        super().__init__()
...
def build_model(config: dict):
    """Build and initialize large ANN model state."""
    ...
    model = SimpleANN(
        ...
        hidden_dim=int(config.get("ann_hidden_dim", 256)),
